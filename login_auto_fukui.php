...
<head>
  ...
  <script>
    function autofillAndSubmit() {
      ...
      usernameInput.value = '俊郎・悦子';
      passwordInput.value = 'fukui';
...
<body class="bg-blue-50" id="body">
    ...
    <div class="flex justify-center">
      <button class="bg-blue-700 hover:bg-green-700 text-white font-bold text-2xl sm:text-2xl py-5 px-6 rounded mb-4" onclick="autofillAndSubmit()">俊郎・悦子さん用<br>スタートボタン</button>
    </div>
