...
.message {padding:10px;margin:14px 0;border:1px solid gray;border-radius:10px;width:80%}
...
.chat-form form{display:flex;gap:10px;border-top:solid 2px gray;padding-top:8px}
.chat-form input{border:solid 1px gray;width:84%;border-radius:4px;padding:3px}
.chat-form button{width:12%;background:blue;color:#fff;border-radius:4px;padding:4px;font-weight:bold}
</style>
</head>
    ...
    <div class="content-wrapper">
        ...
        <div class="container mx-auto mt-20 p-2 bg-white rounded shadow-md max-w-4xl">
            <h1 class="text-3xl font-bold mb-6 text-center">トーク</h1>
                    ...
                    <?php foreach ($messages as $message): ?>
                        ...
                        <div class="message <?php echo $class?>">
                            ...
                            <?php if ($message['message_type'] == 'image' && !empty($message['file_url'])): ?>
                                <img src="uploads/<?php echo  h($message['file_url']) ?>" style="max-width: 200px;">
                            <?php endif; ?>
                ...
                <div class="chat-form">
                    <form action="chat_room.php?chat_id=<?php echo  $chat_id ?>" method="POST" enctype="multipart/form-data">
