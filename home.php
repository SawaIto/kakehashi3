    ...
    <main class="flex items-center justify-center py-8">
        <div class="container mx-auto m-2 p-2 bg-white rounded-lg shadow-md max-w-md">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php if ($user['role'] == 'admin' || $user['role'] == 'modify') : ?>
                        <a href="schedule_input.php" class="block bg-blue-500 hover:bg-blue-300 text-black font-bold px-3 py-2.5 rounded-lg text-sm sm:text-xl text-center transition duration-300">予定登録</a>
                    <?php else : ?>
                        <div></div>
                    <?php endif; ?>
                    <a href="schedule_view.php" class="block bg-blue-300 hover:bg-blue-500 text-black font-bold px-3 py-2.5 rounded-lg text-sm sm:text-xl text-center transition duration-300">予定表示</a>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <?php if ($user['role'] == 'admin' || $user['role'] == 'modify') : ?>
